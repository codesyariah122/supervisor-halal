	...
	<section id="portfolio" class="bg-gray-200 py-24 px-6">
		<div class="max-w-full mx-auto">
			...
			<div class="grid grid-cols-1 place-items-center py-6">
				<div>
					<NuxtLink to="/portfolio" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-full shadow-md flex items-center">
